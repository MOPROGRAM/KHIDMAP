...
/**
 * @fileOverview Automatically categorizes a service provider's ad post into 'Plumbing', 'Electrical', 'Carpentry', 'Painting', 'HomeCleaning', 'Construction', 'Plastering', or 'Other' based on the description.
 *
...
// Updated enum to include new categories
const serviceCategoriesEnum = z.enum(['Plumbing', 'Electrical', 'Carpentry', 'Painting', 'HomeCleaning', 'Construction', 'Plastering', 'Other']);
...
const CategorizeAdOutputSchema = z.object({
  category: serviceCategoriesEnum.describe('The category of the ad. Should be one of Plumbing, Electrical, Carpentry, Painting, HomeCleaning, Construction, Plastering, or Other if none fit well.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert at categorizing service provider ad posts. Given the description of the ad post, determine which of the following categories the ad best fits: "Plumbing", "Electrical", "Carpentry", "Painting", "HomeCleaning", "Construction", "Plastering", or "Other".
